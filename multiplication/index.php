...
// Page configuration
$page_title = 'Multiplication Practice - Interactive Math Quizzes | Smarty Pants Math';
$page_description = 'Master multiplication with interactive quizzes! Choose your difficulty level and practice times tables.';
            ...
            <div class="quiz-main-container">
                ...
                <div class="difficulty-buttons">
                    ...
                    <button class="diff-btn medium-btn <?php echo $current_level == 'medium' ? 'active' : ''; ?>" 
                            onclick="changeDifficulty('medium')">Medium</button>
                ...
                <div class="grade-indicator">
                    ...
                    <select id="gradeDisplay" onchange="handleGradeChange(this.value)">
